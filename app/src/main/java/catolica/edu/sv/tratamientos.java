...
public class tratamientos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(tratamientos.this, Pantalla_1_Dentista.class);
            }
        });
        ...
        grupo_citas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(tratamientos.this, citas.class);
            }
        });
        ...
        grupo_pacientes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(tratamientos.this, paciente.class);
            }
        });
        ...
        grupo_comunicacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(tratamientos.this, comunicacion.class);
            }
        });
        ...
        grupo_configuracion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(tratamientos.this, configuracion.class);
            }
        });
        ...
        grupo_salir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(tratamientos.this, "salir", Toast.LENGTH_SHORT).show();
            }
        });
    }
