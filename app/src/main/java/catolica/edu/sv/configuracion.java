...
public class configuracion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(configuracion.this, Pantalla_1_Dentista.class);
            }
        });
        ...
        grupo_citas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                redirectActivity(configuracion.this, citas.class);
            }
        });
        ...
        grupo_pacientes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(configuracion.this, paciente.class);
            }
        });
        ...
        grupo_tratamientos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(configuracion.this, tratamientos.class);
            }
        });
        ...
        grupo_comunicacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(configuracion.this, comunicacion.class);
            }
        });
        ...
        grupo_salir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(configuracion.this, "salir", Toast.LENGTH_SHORT).show();
            }
        });
    }
